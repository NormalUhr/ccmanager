...
impl Theme {
    ...
    pub fn dark() -> Self {
        Self {
            ...
            timestamp_now: (78, 201, 176), // Kept as teal (legacy timestamp color)
            ...
            search_match_bg: (78, 201, 176), // Kept as teal (legacy search highlight)
    ...
    pub fn light() -> Self {
        Self {
            ...
            accent_dim: (58, 130, 184), // ~60% strength of the new accent

            text_primary: (36, 45, 53),     // Deep slate for body text
            text_secondary: (88, 101, 112), // Cool gray for metadata
            text_muted: (130, 130, 130),    // Light gray for labels
            text_tertiary: (170, 170, 170), // more dim than text_muted (lighter = dimmer on light bg)
